...
public class ApplyAfterschoolDialogFragment extends DialogFragment {

    public static ApplyAfterschoolDialogFragment newInstance(Context context, int no) {
        Bundle args = new Bundle();
        args.putInt(context.getString(R.string.ARGS_NO), no);

        ApplyAfterschoolDialogFragment fragment = new ApplyAfterschoolDialogFragment();
